...
const icons: Record<string, React.ReactNode> = {
  ...
  Workflow: (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="6" height="6" rx="1"/><rect x="15" y="15" width="6" height="6" rx="1"/><path d="M6 9v3a3 3 0 0 0 3 3h6"/><path d="m15 12 3 3-3 3"/></svg>
  ),
  Users: (
...
export function ServiceIcon({ name, className }: ServiceIconProps) {
  return <span className={className}>{icons[name] ?? icons.Search}</span>;
}
